...
@SpringBootTest //單元測試使用
@AutoConfigureMockMvc //為了單元測試或是仿照前端的URL所回傳的http method的請求
public class ProductControllerTest {

    //注入 MockMvc Annotation
    @Autowired
    ...
    //測試創建商品的單元測試
    @Transactional //如果過程中發生異常，變更會回滾，不會影響資料庫
    @Test
    ...
    @Transactional
    @Test
    public void createProduct_illegalArgumentException() throws Exception {
        ProductRequest productRequest = new ProductRequest();
        productRequest.setProductName("test food product" );
        String requestJson = objectMapper.writeValueAsString(productRequest);
