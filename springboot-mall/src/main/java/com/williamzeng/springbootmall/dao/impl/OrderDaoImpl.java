...
import com.williamzeng.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public Integer createOrder(Integer userId,Integer totalAmount){
        ...
        int oderId = keyHolder.getKey().intValue();
...
//            String str = "INSERT INTO order_item(order_id, product_id, quantity, amount)"+
